...
sudo apt -y install git gnupg flex bison build-essential zip curl zlib1g-dev libc6-dev-i386 libncurses5 libx11-dev lib32z1-dev libxml2-utils xsltproc unzip fontconfig gcc make m4 lib32stdc++6 libelf-dev mtools libssl-dev syslinux-utils openssh-client pkgconf genisoimage squashfs-tools coreutils bash libselinux1-dev libsepol-dev wget gettext java-common bc
