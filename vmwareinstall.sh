...
sudo apt -y install coreutils openssl mokutil wget tar
clear
...
wget https://softwareupdate.vmware.com/cds/vmw-desktop/ws/17.5.2/23775571/linux/core/VMware-Workstation-17.5.2-23775571.x86_64.bundle.tar 1>/dev/null 2>/dev/null
tar -xf VMware-Workstation-17.5.2-23775571.x86_64.bundle.tar
chmod 700 VMware-Workstation-17.5.2-23775571.x86_64.bundle
echo
...
sudo /tmp/VMware-Workstation-17.5.2-23775571.x86_64.bundle 1>/dev/null
